...
public class PlayerVSComputer extends AppCompatActivity {
    ...
    private void dice2Tap(int num){
        Handler handler = new Handler();
        handler.postDelayed(this::secondPlayer, 100*(num+2));
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_player_computer);
        ...
        if (Player_Name.length()==0){
            FirstPlayerName.setText(R.string.player);
        }else {
            FirstPlayerName.setText(Player_Name);
        }
        SecondPlayerName.setText(Build.MANUFACTURER);
